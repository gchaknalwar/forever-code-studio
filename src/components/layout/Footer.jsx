        ...
        >
          <div>
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 font-['Space_Grotesk'] text-4xl font-semibold tracking-tight text-white md:text-6xl"
            >
              ...
              <ArrowUpRight className="h-8 w-8 text-white/50 transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-white md:h-10 md:w-10" />
            </a>
          </div>
